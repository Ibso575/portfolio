...
const contactInfo = [
  {
    ...
    label: "Email",
    value: "ibrohimjonsobirov914@gmail.com",
    href: "mailto:ibrohimjonsobirov914@gmail.com",
  },
  {
    icon: <FaPhoneAlt className="text-[#ff6b00]" />,
    label: "Phone",
    value: "+998 99 301 60 73",
    href: "tel:+998993016073",
  },
  {
...
const socials = [
  { icon: <FaGithub />, href: "https://github.com/Ibso575", label: "GitHub" },
  {
    icon: <FaLinkedin />,
    href: "https://www.linkedin.com/in/ibrohim-sobirov-818b9a387/",
    label: "LinkedIn",
  },
  { icon: <FaTelegram />, href: "https://t.me/@i_sobirov5", label: "Telegram" },
];
