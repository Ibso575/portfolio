    ...
    <section id="about" className="bg-black text-white py-20 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p>
              Hi, I'm <span className="text-white font-semibold">Ibrohimjon Sobirov</span>. My journey into technology was driven by a deep curiosity about how digital worlds are built. I recently completed an intensive <span className="text-[#ff6b00] font-bold">8-month Front-End curriculum at Najot Ta’lim</span>, where I transformed from a tech enthusiast into a focused developer.
            </p>
