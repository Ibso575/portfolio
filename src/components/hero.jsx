            ...
            {techIcons.map(({ Icon, color }, index) => {
              ...
              return (
                <div key={index} className="absolute left-1/2 top-1/2" style={{ transform: `rotate(${angle}deg) translate(${radius}px) rotate(-${angle}deg)` }}>
                  <motion.div animate={{ rotate: -360 }} transition={{ duration: 30, repeat: Infinity, ease: "linear" }} className="w-16 h-16 bg-gray-950 border border-gray-800 rounded-2xl flex items-center justify-center shadow-2xl">
